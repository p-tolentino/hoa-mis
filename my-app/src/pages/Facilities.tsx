...
function Facilities () {
  return (
    <Box id='facilitiesSection' m={'3rem'}>
      <Heading size='lg' mb='1rem'>
        Facilities
      </Heading>
      <Flex>
        <Card maxW='md' pos={'static'}>
          <CardBody>
            <Image
            ...
            <Stack mt='6' spacing='3'>
              ...
              <Divider />
              <Text>
                Welcome to the charming Clubhouse nestled within the heart of
                our inviting subdivision. A beacon of community spirit and
                leisure, this meticulously designed facility offers residents a
                versatile space for socializing, recreation, and shared
                experiences.
              </Text>
            </Stack>
          </CardBody>
          ...
          <CardBody>
            ...
            <Stack mt='6' spacing='3'>
              ...
              <Text>
                ...
                backdrop of modern architecture, our community swimming pool is
                a haven for residents seeking relaxation, exercise, and social
                connections.
              </Text>
            </Stack>
          </CardBody>
          ...
          <CardBody>
            ...
            <Stack mt='6' spacing='3'>
              ...
              <Text>
                ...
                vibrant subdivision. This outdoor haven is more than just a
                place to shoot hoops; it's a focal point where residents come
                together to engage in friendly competition, build camaraderie,
