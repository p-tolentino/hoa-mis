      ...
      >
        ...
        <Flex mt={4} align="center">
          ...
          <Flex
            ...
            display={sidebarSize === "small" ? "none" : "flex"}
          >
            <Heading as="h3" size="sm" fontFamily="montserrat variable">
              John Doe
            </Heading>
            <Text color="brand.300" fontFamily="cabin variable">
              Admin
            </Text>
          </Flex>
        </Flex>
        <Flex
          ...
          display={sidebarSize === "small" ? "none" : "flex"}
        >
          <Text as={Link} fontFamily="cabin variable">
            Settings
          </Text>
        </Flex>
        <Flex
        ...
        <Flex
          ...
          display={sidebarSize === "small" ? "none" : "flex"}
        >
          <Text as={NavLink} to={"/"} fontFamily="cabin variable">
            Sign Out
          </Text>
        </Flex>
      </Flex>
